...
$routes->post('(:num)/restore', 'Note::restore/$1', ['filter' => 'auth']);
$routes->post('(:num)/delete', 'Note::destroy/$1', ['filter' => 'auth']);
$routes->post('trash/empty', 'Note::emptyTrash', ['filter' => 'auth']);
